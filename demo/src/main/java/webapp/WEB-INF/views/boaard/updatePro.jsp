...
boarddto.getWriter().trim().equals("")){ response.sendRedirect("list.jsp");
return; } */ int num = Integer.parseInt(request.getParameter("num")); int res =
boarddao.updateBoardNew(boarddto, num); if (res > 0){%>
